...
public class O2WEleConnector {
	 ...
	 */
	public O2WEleConnector(VectorXZ pos, Object reference, GroundState groundState) {
		assert pos != null;
		this.pos = pos;
	 ...
	 * Only for use by an { ElevationCalculator}.
	 * 
	 ...
	 * { EleConnector}: It is null before elevation calculation,
	 ...
	 */
	public boolean connectsTo(O2WEleConnector other) {
