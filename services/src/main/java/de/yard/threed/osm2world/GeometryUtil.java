...
public final class GeometryUtil {
	 ...
	 *                            (not yet implemented)
	 */
	/*11.11.21 public static List<VectorXZ> distributePointsOn(
	 ...
	 */
	/*11.11.21public static final List<VectorXYZW> calculateTangentVectorsForTexLayer(List<VectorXYZ> vertices, List<VectorXYZ> normals,
	 ...
	 */
	/*11.11.21public static final List<VectorXYZW> calculateShadowVolumesPerTriangle(List<VectorXYZ> vertices, VectorXYZW lightPos) {
	 ...
	 */
	/*11.11.21private static List<VectorXYZW> emitQuad(VectorXYZ start, VectorXYZ end, VectorXYZW lightPos) {
