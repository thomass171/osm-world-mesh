...
public class MetricMapProjection extends O2WOriginMapProjection {
	...
	public void setOrigin(LatLon origin) {
		...
		this.originY = MercatorProjection.latToY(origin.getLatDeg().getDegree()) * scaleFactor;
		this.originX = MercatorProjection.lonToX(origin.getLonDeg().getDegree()) * scaleFactor;
	}
}
