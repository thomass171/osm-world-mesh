...
function createLink(href) {
    var id = "a_" + getUniqueId();
    // <a href="https://threejs.org" target="_blank" ><i class="fa fa-external-link" aria-hidden="true"></i></a>
...
function clearList(listid) {
    //$("#" + listid).innerHTML = "";
    var listElements = document.querySelectorAll("#" + listid + " li");
