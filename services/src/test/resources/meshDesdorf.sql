...
insert into worldmesh.meshline values(1, 1, 2, null, null);
insert into worldmesh.meshline values(2, 2, 3, null, null);
insert into worldmesh.meshline values(3, 3, 1, null, null);
