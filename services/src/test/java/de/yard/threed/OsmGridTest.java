...
public class OsmGridTest {
    ...
    private void dotestDesdorfK41SegmentGrid(Configuration customconfig, boolean elevated, String configsuffix) throws IOException {
        ...
        if (!elevated) {
            ...
            assertEleConnectorGroup("K41elevations", road.getEleConnectorGroups(), new float[]{68, 68, 68, 68, 68, 68});
    ...
    public void doB55B477(String gridname, int expectedobjects) throws IOException {
        ...
        assertEleConnectorGroup("railways", railways.get(0).getEleConnectorGroups(), new float[]{68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68});
        ...
        assertBasicGraph(SceneryContext.getInstance().getGraph(SceneryObject.Category.ROAD), 68);
    ...
    public void testWayland() throws IOException, InvalidDataException {
        ...
        assertBasicGraph(processResults.roadGraph, 68);
        assertBasicGraph(processResults.railwayGraph, 68);
