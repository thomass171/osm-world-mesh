...
public class WayAreaTest {
    ...
    public void testAdd() {
        ...
        TestUtils.assertVector2(new Vector2(5, width2), toVector2(wayArea.getPair(2).getSecond()),"wayArea.pair[2].left");
        SceneryTestUtil.assertCoordinate("wayArea.pair[2].right", new Coordinate(5, -width2), wayArea.getPair(2).getFirst());
    }
    ...
    public void testSegments() {
        ...
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment[0]", new Coordinate(0, -width2), wayArea.getPairsOfSegment(0)[0].right(), 0.01);
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment[0]", new Coordinate(3, -width2), wayArea.getPairsOfSegment(0)[1].right(), 0.01);
        assertEquals(2, wayArea.getPairsOfSegment(1).length, "wayArea.getPairsOfSegment[1].size");
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment[1]", new Coordinate(3.5, -width2), wayArea.getPairsOfSegment(1)[0].right(), 0.01);
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment[1]", new Coordinate(5, -width2), wayArea.getPairsOfSegment(1)[1].right(), 0.01);
        ...
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment0[0]", new Coordinate(0, -width2), wayArea.getPairsOfSegment(0)[0].right(), 0.01);
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment0[1]", new Coordinate(1, -width2), wayArea.getPairsOfSegment(0)[1].right(), 0.01);
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment0[2]", new Coordinate(3, -width2), wayArea.getPairsOfSegment(0)[2].right(), 0.01);
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment0[3]", new Coordinate(4.5, -width2), wayArea.getPairsOfSegment(0)[3].right(), 0.01);
        SceneryTestUtil.assertCoordinate("wayArea.getPairsOfSegment0[4]", new Coordinate(5, -width2), wayArea.getPairsOfSegment(0)[4].right(), 0.01);
