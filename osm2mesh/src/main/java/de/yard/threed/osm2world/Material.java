...
public abstract class Material {
    // optional for "external" material definitions, eg. for finding textures.
    ...
    public Material(Interpolation interpolation, Color color,
        ...
        //25.4.19: Why a diffuseFactor of 0.5?
        this(interpolation, color, 0.5f, 1/*0.5*/, 0.0f, 1, transparency,
    ...
    public String toString() {
        return String.format("{%s, %s, #%06x, a%3f, d%3f, s%3f, sh%d, %d tex, ",
                name, interpolation, color.getRGB() & 0x00ffffff, ambientFactor,
