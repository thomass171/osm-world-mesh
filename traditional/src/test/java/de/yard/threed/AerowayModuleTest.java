...
public class AerowayModuleTest {
    ...
    public void testTestData() throws IOException, MeshInconsistencyException {
        ...
        AerowayModule aerowayModule = new AerowayModule(null,null, null);
        ...
        TestUtil.assertTriangleStrip(vd, new Vector2(expectedatlassegment * cellsize, 0.25), new Vector2((expectedatlassegment + 2) * cellsize, 0.5));
   ...
   /*9.2.26   @Test
    ...
    public void dotestEDDKSmall(boolean osmOnly, int expectedtaxiways, int expectedwaymapsize, String c4name, double c4x, double c4heading) throws IOException, MeshInconsistencyException {
        ...
        //triangle strip
        TestUtil.assertUVs(vd, new Vector2(0.875, 1), new Vector2((0.875), 0.875), new Vector2(1, 1), new Vector2(1, 0.875));
    }
