...
public class OsmUtilTest {
    ...
    public void testDirection() {
        MapNode n0 = new MapNode(new VectorXZ(0,0),null);
        MapNode n1 = new MapNode(new VectorXZ(2,0),null);
        MapNode n2 = new MapNode(new VectorXZ(4,2),null);
        ...
        /*20.3.26 TestUtils.assertVector2(new Vector2(1,0), OsmUtil.getDirectionToNode(w0,n1),"dir");
